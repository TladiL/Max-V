...
SIGNAL \inst|reading_coin_1~regout\ : std_logic;
SIGNAL \inst|reading_coin_2~regout\ : std_logic;
SIGNAL \inst|sum[2]~8_combout\ : std_logic;
SIGNAL \inst|sum[0]~7\ : std_logic;
SIGNAL \inst|sum[0]~7COUT1_10\ : std_logic;
SIGNAL \inst|sum[1]~5\ : std_logic;
SIGNAL \inst|sum[1]~5COUT1_11\ : std_logic;
SIGNAL \inst|sum[2]~3\ : std_logic;
SIGNAL \inst|sum[2]~3COUT1_12\ : std_logic;
...
SIGNAL \inst|LEDY~0_combout\ : std_logic;
SIGNAL \inst|LEDX~regout\ : std_logic;
SIGNAL \inst|LEDY~regout\ : std_logic;
...
\inst|reading_coin_1\ : maxv_lcell
-- Equation(s):
-- \inst|reading_coin_1~regout\ = DFFEAS(VCC, !GLOBAL(\Restart~combout\), GLOBAL(\Reset~combout\), , , , , , )
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|reading_coin_1~regout\);

-- Location: LC_X12_Y6_N2
\inst|reading_coin_2\ : maxv_lcell
-- Equation(s):
-- \inst|reading_coin_2~regout\ = DFFEAS((((\inst|reading_coin_1~regout\) # (\inst|reading_coin_2~regout\))), !GLOBAL(\Restart~combout\), GLOBAL(\Reset~combout\), , , , , , )
...
PORT MAP (
	clk => \ALT_INV_Restart~combout\,
	datac => \inst|reading_coin_1~regout\,
	datad => \inst|reading_coin_2~regout\,
	aclr => \ALT_INV_Reset~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|reading_coin_2~regout\);

-- Location: LC_X12_Y6_N1
\inst|sum[2]~8\ : maxv_lcell
-- Equation(s):
-- \inst|sum[2]~8_combout\ = (((!\inst|reading_coin_2~regout\) # (!\inst|reading_coin_1~regout\)))
...
-- Equation(s):
-- \inst|sum\(0) = DFFEAS(\inst|sum\(0) $ ((\coin~combout\(0))), !GLOBAL(\Restart~combout\), GLOBAL(\Reset~combout\), , \inst|sum[2]~8_combout\, , , , )
-- \inst|sum[0]~7\ = CARRY((\inst|sum\(0) & (\coin~combout\(0))))
-- \inst|sum[0]~7COUT1_10\ = CARRY((\inst|sum\(0) & (\coin~combout\(0))))
...
PORT MAP (
	...
	aclr => \ALT_INV_Reset~combout\,
	ena => \inst|sum[2]~8_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|sum\(0),
	cout0 => \inst|sum[0]~7\,
	cout1 => \inst|sum[0]~7COUT1_10\);

-- Location: LC_X12_Y6_N6
\inst|sum[1]\ : maxv_lcell
-- Equation(s):
-- \inst|sum\(1) = DFFEAS(\inst|sum\(1) $ (\coin~combout\(1) $ ((\inst|sum[0]~7\))), !GLOBAL(\Restart~combout\), GLOBAL(\Reset~combout\), , \inst|sum[2]~8_combout\, , , , )
-- \inst|sum[1]~5\ = CARRY((\inst|sum\(1) & (!\coin~combout\(1) & !\inst|sum[0]~7\)) # (!\inst|sum\(1) & ((!\inst|sum[0]~7\) # (!\coin~combout\(1)))))
-- \inst|sum[1]~5COUT1_11\ = CARRY((\inst|sum\(1) & (!\coin~combout\(1) & !\inst|sum[0]~7COUT1_10\)) # (!\inst|sum\(1) & ((!\inst|sum[0]~7COUT1_10\) # (!\coin~combout\(1)))))
...
PORT MAP (
	...
	ena => \inst|sum[2]~8_combout\,
	cin0 => \inst|sum[0]~7\,
	cin1 => \inst|sum[0]~7COUT1_10\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|sum\(1),
	cout0 => \inst|sum[1]~5\,
	cout1 => \inst|sum[1]~5COUT1_11\);

-- Location: LC_X12_Y6_N7
\inst|sum[2]\ : maxv_lcell
-- Equation(s):
-- \inst|sum\(2) = DFFEAS(\coin~combout\(2) $ (\inst|sum\(2) $ ((!\inst|sum[1]~5\))), !GLOBAL(\Restart~combout\), GLOBAL(\Reset~combout\), , \inst|sum[2]~8_combout\, , , , )
-- \inst|sum[2]~3\ = CARRY((\coin~combout\(2) & ((\inst|sum\(2)) # (!\inst|sum[1]~5\))) # (!\coin~combout\(2) & (\inst|sum\(2) & !\inst|sum[1]~5\)))
-- \inst|sum[2]~3COUT1_12\ = CARRY((\coin~combout\(2) & ((\inst|sum\(2)) # (!\inst|sum[1]~5COUT1_11\))) # (!\coin~combout\(2) & (\inst|sum\(2) & !\inst|sum[1]~5COUT1_11\)))
...
PORT MAP (
	...
	ena => \inst|sum[2]~8_combout\,
	cin0 => \inst|sum[1]~5\,
	cin1 => \inst|sum[1]~5COUT1_11\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|sum\(2),
	cout0 => \inst|sum[2]~3\,
	cout1 => \inst|sum[2]~3COUT1_12\);
...
-- Equation(s):
-- \inst|sum\(3) = DFFEAS(\coin~combout\(3) $ (((\inst|sum[2]~3\ $ (\inst|sum\(3))))), !GLOBAL(\Restart~combout\), GLOBAL(\Reset~combout\), , \inst|sum[2]~8_combout\, , , , )
...
-- Equation(s):
-- \inst1|inst5~0_combout\ = (\inst|sum\(2) & (!\inst|sum\(3) & (\inst|sum\(1) $ (!\inst|sum\(0))))) # (!\inst|sum\(2) & (((!\inst|sum\(3))) # (!\inst|sum\(1))))
...
-- Equation(s):
-- \inst1|inst5D~0_combout\ = (\inst|sum\(2) & (!\inst|sum\(3) & (\inst|sum\(1) $ (\inst|sum\(0))))) # (!\inst|sum\(2) & ((\inst|sum\(1) & ((!\inst|sum\(3)))) # (!\inst|sum\(1) & (!\inst|sum\(0)))))
...
-- Equation(s):
-- \inst1|inst6SA~0_combout\ = (\inst|sum\(2) & (!\inst|sum\(3) & ((!\inst|sum\(0)) # (!\inst|sum\(1))))) # (!\inst|sum\(2) & (!\inst|sum\(1) & ((\inst|sum\(3)) # (!\inst|sum\(0)))))
...
-- Equation(s):
-- \inst1|inst6SA22~0_combout\ = (\inst|sum\(3)) # ((\inst|sum\(2) & ((!\inst|sum\(0)) # (!\inst|sum\(1)))) # (!\inst|sum\(2) & (\inst|sum\(1))))
...
\inst|LEDY~0\ : maxv_lcell
-- Equation(s):
-- \inst|LEDY~0_combout\ = (!\coin~combout\(3) & (\coin~combout\(1) & ((!\inst|reading_coin_2~regout\) # (!\inst|reading_coin_1~regout\))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \inst|LEDY~0_combout\);

-- Location: LC_X12_Y6_N9
\inst|LEDX\ : maxv_lcell
-- Equation(s):
-- \inst|LEDX~regout\ = DFFEAS((\inst|LEDX~regout\) # ((\coin~combout\(2) & (\coin~combout\(0) & \inst|LEDY~0_combout\))), !GLOBAL(\Restart~combout\), GLOBAL(\Reset~combout\), , , , , , )
...
PORT MAP (
	...
	dataa => \coin~combout\(2),
	datab => \coin~combout\(0),
	datac => \inst|LEDX~regout\,
	datad => \inst|LEDY~0_combout\,
	aclr => \ALT_INV_Reset~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|LEDX~regout\);

-- Location: LC_X12_Y6_N0
\inst|LEDY\ : maxv_lcell
-- Equation(s):
-- \inst|LEDY~regout\ = DFFEAS((\inst|LEDY~regout\) # ((!\coin~combout\(2) & (!\coin~combout\(0) & \inst|LEDY~0_combout\))), !GLOBAL(\Restart~combout\), GLOBAL(\Reset~combout\), , , , , , )
...
PORT MAP (
	...
	dataa => \coin~combout\(2),
	datab => \coin~combout\(0),
	datac => \inst|LEDY~regout\,
	datad => \inst|LEDY~0_combout\,
	aclr => \ALT_INV_Reset~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|LEDY~regout\);

-- Location: LC_X12_Y7_N3
\inst|LessThan0~0\ : maxv_lcell
-- Equation(s):
-- \inst|LessThan0~0_combout\ = ((!\inst|sum\(2) & (!\inst|sum\(1) & !\inst|sum\(0)))) # (!\inst|sum\(3))
...
-- pragma translate_on
PORT MAP (
	datain => \inst|ALT_INV_LessThan0~0_combout\,
	oe => VCC,
	padio => ww_Z);
END structure;
